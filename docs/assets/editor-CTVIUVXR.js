import{a as e,c as t,d as n,f as r,i,l as a,m as o,n as s,o as c,p as l,r as u,s as d,t as f,u as p}from"./LevelScene-C9RUNBIw.js";function m(e){return structuredClone(e)}function h(e){return`craft-heroes-level:${e}`}function g(e){return`craft-heroes-campaign:${e}`}function _(e){localStorage.setItem(h(e.id),JSON.stringify(e,null,2))}function v(e){localStorage.setItem(g(e.id),JSON.stringify(e,null,2))}function y(e,t){return e.tiles[t.z]?.[t.x]}function b(e,t){return t.x>=0&&t.z>=0&&t.x<e.width&&t.z<e.depth}function x(e,t,n){let r=m(e),i=y(r,t);return i&&(i.height=Math.max(0,Math.min(6,i.height+n))),r}function ee(e,t,n){let r=m(e),i=y(r,t);return i&&(i.terrain=n),r}function te(e,t,n,r=`grass`){let i=m(e),a=Math.max(4,Math.min(32,Math.round(t))),o=Math.max(4,Math.min(32,Math.round(n)));return i.width=a,i.depth=o,i.tiles=Array.from({length:o},(t,n)=>Array.from({length:a},(t,i)=>{let a=e.tiles[n]?.[i];return a?{...a}:{height:1,terrain:r}})),i.obstacles=i.obstacles.filter(e=>b(i,e)),i.units=i.units.filter(e=>b(i,e)),i}function ne(e,t,n,r=0){let i=m(e);return i.obstacles=i.obstacles.filter(e=>e.x!==t.x||e.z!==t.z),i.obstacles.push({id:`obs-${n}-${Date.now()}`,type:n,x:t.x,z:t.z,rotation:r}),i}function re(e,t,n,r){let i=m(e);return i.units=i.units.filter(e=>e.x!==t.x||e.z!==t.z),i.units.push({id:`${n}-${Date.now()}`,team:n,templateId:r.id,name:n===`player`?`Player Cube`:r.name,x:t.x,z:t.z,hp:r.hp,rotations:{head:0,body:n===`enemy`?2:0,legs:0},faces:structuredClone(r.faces)}),i}function ie(e,t){let n=m(e);return n.obstacles=n.obstacles.filter(e=>e.x!==t.x||e.z!==t.z),n.units=n.units.filter(e=>e.x!==t.x||e.z!==t.z),n}function ae(e){let t=[];e.units.some(e=>e.team===`player`)||t.push(`No player unit placed.`),e.units.some(e=>e.team===`enemy`)||t.push(`No enemy units placed.`),e.objectives.length===0&&t.push(`No objective configured.`);for(let n of e.units)b(e,n)||t.push(`${n.name} is outside the board.`);return t}var oe=[`S`,`E`,`N`,`W`],S=[`head`,`body`,`legs`],C=[`active`,`passive`,`onMove`,`onAttack`,`onDefend`,`onSupport`],w=[`buff`,`debuff`,`trap`,`status`],T=[{key:`attack`,label:`ATK`},{key:`defense`,label:`DEF`},{key:`move`,label:`MOVE`},{key:`range`,label:`RNG`},{key:`support`,label:`SUP`}],E=`craft-heroes-unit-templates`,D=`craft-heroes-class-definitions`,O=`craft-heroes-environment-materials`,k=`craft-heroes-prop-definitions`;function A(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#039;`})[e])}function j(e){return e?`<img src="${A(e)}" alt="">`:``}function se(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`build-${Date.now()}`}function ce(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`class-${Date.now()}`}function le(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`material-${Date.now()}`}function ue(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`prop-${Date.now()}`}function M(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`level-${Date.now()}`}function de(e){let t=M(e);return t.endsWith(`.json`)?t:`${t}.json`}function N(e){try{let t=localStorage.getItem(e);return t?JSON.parse(t):void 0}catch{return}}function P(e,t){let n=Number(e);return Number.isFinite(n)?n:t}function fe(e){return{attack:Math.max(0,Math.min(12,P(e?.attack,0))),defense:Math.max(0,Math.min(12,P(e?.defense,0))),move:Math.max(0,Math.min(12,P(e?.move,0))),range:Math.max(0,Math.min(12,P(e?.range,0))),support:Math.max(0,Math.min(12,P(e?.support,0)))}}function F(e){return{attack:Math.max(-12,Math.min(12,P(e?.attack,0))),defense:Math.max(-12,Math.min(12,P(e?.defense,0))),move:Math.max(-12,Math.min(12,P(e?.move,0))),range:Math.max(-12,Math.min(12,P(e?.range,0))),support:Math.max(-12,Math.min(12,P(e?.support,0))),initiative:Math.max(-12,Math.min(12,P(e?.initiative,0)))}}function pe(e){return Object.entries(e).filter(([,e])=>Number(e)!==0).map(([e,t])=>`${e}:${t}`).join(`;`)}function me(e){let t={};for(let n of e.split(`;`).map(e=>e.trim()).filter(Boolean)){let[e,r]=n.split(`:`).map(e=>e.trim());if(!e)continue;let i=P(r,0);[`attack`,`defense`,`move`,`range`,`support`,`initiative`].includes(e)&&(t[e]=Math.max(-12,Math.min(12,i)))}return F(t)}function I(e,t){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`${t}-${Date.now()}`}function L(e,t){let n=e.name||e.description||`Ability ${t+1}`,r=C.includes(e.trigger)?e.trigger:`passive`;return{id:e.id||I(n,`ability`),name:n,trigger:r,icon:(e.icon||n.slice(0,2)||`FX`).toUpperCase().slice(0,3),color:z(e.color)?e.color:`#60d7e4`,description:e.description||``,effect:e.effect||``}}function he(e){return Array.isArray(e)?e.map((e,t)=>L(e,t)):[]}function R(e){return e===`grass`||e===`water`||e===`solid`?e:`solid`}function z(e){return typeof e==`string`&&/^#[0-9a-f]{6}$/i.test(e)}function B(e,t){return[...Array.isArray(e)?e.filter(z):[],...t.filter(z),`#79b95a`,`#94c866`,`#b1dc70`].slice(0,3)}function ge(e){let t=P(e,0),n=Math.PI/2;return(Math.round(t/n)%4+4)%4*n}function V(e){let t=d[0],n=e.id||ce(e.name||`class`),r={};for(let n of S){let i=e.sections?.[n]??t.sections[n];r[n]={imageUrl:typeof i.imageUrl==`string`?i.imageUrl:``,stats:fe(i.stats),abilities:he(i.abilities),conditions:Array.isArray(i.conditions)?i.conditions.map(String).filter(Boolean):[]}}return{id:n,name:e.name||n,color:e.color||t.color,sections:r}}function H(...e){let t=new Map;for(let n of e)for(let e of n){let n=V(e);t.set(n.id,n)}return[...t.values()]}function U(e){let t=e?.backgroundModel;return{skyColor:e?.skyColor||a.skyColor,fogColor:e?.fogColor||a.fogColor,groundColor:e?.groundColor||a.groundColor,groundTextureUrl:e?.groundTextureUrl||``,ambientIntensity:Math.max(0,Math.min(4,P(e?.ambientIntensity,a.ambientIntensity))),sunIntensity:Math.max(0,Math.min(6,P(e?.sunIntensity,a.sunIntensity))),windStrength:Math.max(0,Math.min(3,P(e?.windStrength,a.windStrength))),windSpeed:Math.max(0,Math.min(4,P(e?.windSpeed,a.windSpeed))),backgroundModel:{modelUrl:typeof t?.modelUrl==`string`?t.modelUrl:``,modelFileName:typeof t?.modelFileName==`string`?t.modelFileName:``,fitToMap:t?.fitToMap??!0,scale:Math.max(.01,Math.min(20,P(t?.scale,1))),rotation:P(t?.rotation,0),offsetY:Math.max(-20,Math.min(20,P(t?.offsetY,0)))}}}function W(e){let n=t[0],r=e.id||le(e.name||n.name);return{id:r,name:e.name||r,surfaceEffect:R(e.surfaceEffect??n.surfaceEffect),grassDensity:Math.max(0,Math.min(30,P(e.grassDensity,n.grassDensity??0))),grassHeightMin:Math.max(.01,Math.min(.3,P(e.grassHeightMin,n.grassHeightMin??.03))),grassHeightMax:Math.max(.01,Math.min(.35,P(e.grassHeightMax,n.grassHeightMax??.095))),grassColors:B(e.grassColors,n.grassColors??[]),topColor:e.topColor||n.topColor,sideColor:e.sideColor||n.sideColor,sideCapColor:e.sideCapColor||e.sideColor||n.sideCapColor,sideFullColor:e.sideFullColor||e.sideColor||n.sideFullColor,sideHalfColor:e.sideHalfColor||e.sideColor||n.sideHalfColor,topImageUrl:typeof e.topImageUrl==`string`?e.topImageUrl:``,sideImageUrl:typeof e.sideImageUrl==`string`?e.sideImageUrl:``,sideCapImageUrl:typeof e.sideCapImageUrl==`string`?e.sideCapImageUrl:typeof e.sideImageUrl==`string`?e.sideImageUrl:``,sideFullImageUrl:typeof e.sideFullImageUrl==`string`?e.sideFullImageUrl:typeof e.sideImageUrl==`string`?e.sideImageUrl:``,sideHalfImageUrl:typeof e.sideHalfImageUrl==`string`?e.sideHalfImageUrl:typeof e.sideImageUrl==`string`?e.sideImageUrl:``,topRule:e.topRule||``,sideRule:e.sideRule||``,movementCost:Math.max(1,Math.min(9,P(e.movementCost,1))),blocksLineOfSight:!!e.blocksLineOfSight}}function G(...e){let t=new Map;for(let n of e)for(let e of n){let n=W(e);t.set(n.id,n)}return[...t.values()]}function K(e){let t=r[0],n=e.id||ue(e.name||t.name),i=e.role===`cover`||e.role===`decor`||e.role===`blocker`?e.role:t.role;return{id:n,name:e.name||n,role:i,assetKind:e.assetKind===`glb`?`glb`:`box`,windEffect:!!(e.windEffect??t.windEffect),emitsLight:!!(e.emitsLight??t.emitsLight),lightColor:z(e.lightColor)?e.lightColor:t.lightColor||`#ffb85c`,lightIntensity:Math.max(0,Math.min(8,P(e.lightIntensity,t.lightIntensity??1.4))),lightRange:Math.max(.5,Math.min(16,P(e.lightRange,t.lightRange??4))),lightOffsetY:Math.max(0,Math.min(5,P(e.lightOffsetY,t.lightOffsetY??t.height))),color:e.color||t.color,textureUrl:typeof e.textureUrl==`string`?e.textureUrl:``,modelUrl:typeof e.modelUrl==`string`?e.modelUrl:``,modelFileName:typeof e.modelFileName==`string`?e.modelFileName:``,fitModelToTile:e.fitModelToTile??!0,width:Math.max(.1,Math.min(3,P(e.width,t.width))),height:Math.max(.1,Math.min(4,P(e.height,t.height))),depth:Math.max(.1,Math.min(3,P(e.depth,t.depth))),blocksMovement:e.blocksMovement??i!==`decor`,blocksLineOfSight:!!e.blocksLineOfSight,coverBonus:Math.max(0,Math.min(9,P(e.coverBonus,+(i===`cover`)))),notes:Array.isArray(e.notes)?e.notes.map(String).filter(Boolean):[]}}function q(...e){let t=new Map;for(let n of e)for(let e of n){let n=K(e);t.set(n.id,n)}return[...t.values()]}function _e(e,t,n,r){let i=e.trigger===`tileEnter`||e.trigger===`levelComplete`?e.trigger:`levelStart`,a=e.presentation===`screen`?`screen`:`dialog`,o={id:String(e.id||`story-${t+1}`),trigger:i,presentation:a,title:String(e.title??``),speaker:String(e.speaker??``),text:String(e.text||`New story beat`),avatarUrl:typeof e.avatarUrl==`string`?e.avatarUrl:``};return i===`tileEnter`&&(o.x=Math.max(0,Math.min(Math.max(0,n-1),Math.round(P(e.x,0)))),o.z=Math.max(0,Math.min(Math.max(0,r-1),Math.round(P(e.z,0))))),o}function J(e){return{...e,environment:U(e.environment),obstacles:Array.isArray(e.obstacles)?e.obstacles.map(e=>({...e,rotation:ge(e.rotation)})):[],surroundings:Array.isArray(e.surroundings)?e.surroundings:[],units:Array.isArray(e.units)?e.units.map(e=>({...e,conditions:Array.isArray(e.conditions)?e.conditions.map(e=>({id:String(e.id??``),turns:Math.max(0,Math.min(12,P(e.turns,0))),stacks:Math.max(1,Math.min(9,P(e.stacks,1))),source:e.source})).filter(e=>e.id):[]})):[],story:Array.isArray(e.story)?e.story.map((t,n)=>_e(t,n,e.width,e.depth)):[]}}function Y(e,t){let n=c.titleScreen;return{kicker:e?.kicker||n?.kicker||`Voxel tactics prototype`,headline:e?.headline||n?.headline||`Craft Heroes`,subhead:e?.subhead||n?.subhead||`Rotate class faces, chain handmade levels, and test the build language for a Steam-ready tactics pitch.`,backgroundLevelId:e?.backgroundLevelId||n?.backgroundLevelId||t,cameraOrbit:e?.cameraOrbit??n?.cameraOrbit??!0,orbitSpeed:Math.max(.01,Math.min(.4,P(e?.orbitSpeed,n?.orbitSpeed??.08))),mockBattle:e?.mockBattle??n?.mockBattle??!0}}function X(e,t){let n=p.conditions[t]??p.conditions[0],r=e.name||n.name||`Condition ${t+1}`,i=w.includes(e.kind)?e.kind:n.kind;return{id:e.id||I(r,`condition`),name:r,kind:i,icon:(e.icon||r.slice(0,2)||`FX`).toUpperCase().slice(0,3),color:z(e.color)?e.color:n.color,duration:Math.max(0,Math.min(12,P(e.duration,n.duration))),stackable:!!(e.stackable??n.stackable),hidden:!!(e.hidden??n.hidden),description:e.description||n.description||``,modifiers:F(e.modifiers??n.modifiers),effect:e.effect||``}}function Z(e){let t=Array.isArray(e?.conditions)?e.conditions:p.conditions;return{initiative:{base:Math.max(0,Math.min(50,P(e?.initiative?.base,p.initiative.base))),headWeight:Math.max(0,Math.min(5,P(e?.initiative?.headWeight,p.initiative.headWeight))),bodyWeight:Math.max(0,Math.min(5,P(e?.initiative?.bodyWeight,p.initiative.bodyWeight))),legsWeight:Math.max(0,Math.min(5,P(e?.initiative?.legsWeight,p.initiative.legsWeight))),heightWeight:Math.max(0,Math.min(5,P(e?.initiative?.heightWeight,p.initiative.heightWeight))),conditionWeight:Math.max(0,Math.min(5,P(e?.initiative?.conditionWeight,p.initiative.conditionWeight))),random:Math.max(0,Math.min(10,P(e?.initiative?.random,p.initiative.random))),tieBreaker:e?.initiative?.tieBreaker===`enemy`||e?.initiative?.tieBreaker===`higherHp`?e.initiative.tieBreaker:p.initiative.tieBreaker},conditions:t.map((e,t)=>X(e,t))}}function Q(e,t){let n=new Set(t.map(e=>e.id)),r=Array.isArray(e.levels)&&e.levels.length>0?e.levels.filter(e=>typeof e.id==`string`&&e.id).map(e=>({id:e.id,file:e.file||`levels/${e.id}.json`,next:Array.isArray(e.next)?e.next.filter(e=>typeof e==`string`&&e):[]})):t.map((e,n)=>({id:e.id,file:`levels/${e.id}.json`,next:t[n+1]?[t[n+1].id]:[]})),i=new Set(r.map(e=>e.id));for(let e of t)i.has(e.id)||r.push({id:e.id,file:`levels/${e.id}.json`,next:e.links[0]?.to?[e.links[0].to]:[]});let a=t[0]?.id??c.startLevel,o=n.has(e.startLevel)?e.startLevel:r[0]?.id??a;return{...e,id:e.id||c.id,title:e.title||c.title,startLevel:o,titleScreen:Y(e.titleScreen,o),gameplay:Z(e.gameplay),levels:r}}function ve(){let e=N(D);return Array.isArray(e)&&e.length>0?H(d,e):d.map(e=>structuredClone(e))}function ye(){let e=N(O);return Array.isArray(e)&&e.length>0?G(t,e):t.map(e=>structuredClone(e))}function be(){let e=N(k);return Array.isArray(e)&&e.length>0?q(r,e):r.map(e=>structuredClone(e))}function xe(){let e=N(E);return Array.isArray(e)&&e.length>0?e.map(e=>structuredClone(e)):o.map(e=>structuredClone(e))}function $(e){return e.join(`; `)}function Se(e){return e.map(e=>[e.name,e.trigger,e.icon,e.color,e.description,e.effect].map(e=>e.trim()).join(` | `)).join(`
`)}function Ce(e,t=[]){let n=e.split(/[;\n]+/).map(e=>e.trim()).filter(Boolean);return n.length===0?t:n.map((e,t)=>{let[n=`Ability ${t+1}`,r=`passive`,i=``,a=`#60d7e4`,o=``,s=``]=e.split(`|`).map(e=>e.trim());return L({id:I(n,`ability`),name:n,trigger:C.includes(r)?r:`passive`,icon:i,color:a,description:o,effect:s},t)})}function we(e){return e.split(/[,;\n]+/).map(e=>e.trim()).filter(Boolean)}function Te(e){return e.map(e=>[e.name,e.kind,e.icon,e.color,String(e.duration),e.stackable?`stack`:`single`,e.hidden?`hidden`:`shown`,pe(e.modifiers),e.effect,e.description].map(e=>e.trim()).join(` | `)).join(`
`)}function Ee(e,t){let n=e.split(`
`).map(e=>e.trim()).filter(Boolean);return n.length===0?t:n.map((e,t)=>{let[n=`Condition ${t+1}`,r=`status`,i=``,a=`#60d7e4`,o=`1`,s=`single`,c=`shown`,l=``,u=``,d=``]=e.split(`|`).map(e=>e.trim());return X({id:I(n,`condition`),name:n,kind:w.includes(r)?r:`status`,icon:i,color:a,duration:P(o,1),stackable:/^stack/i.test(s),hidden:/^hidden/i.test(c),modifiers:me(l),effect:u,description:d},t)})}var De=class{constructor(e){s(this,`root`,void 0),s(this,`canvas`,void 0),s(this,`scene`,void 0),s(this,`panel`,void 0),s(this,`utility`,void 0),s(this,`levels`,n.map(e=>J(m(e)))),s(this,`campaign`,Q(structuredClone(c),this.levels)),s(this,`templates`,xe()),s(this,`classDefinitions`,ve()),s(this,`environmentMaterials`,ye()),s(this,`propDefinitions`,be()),s(this,`state`,{mode:`editor`,tool:`select`,terrain:this.environmentMaterials[0].id,obstacle:this.propDefinitions[0].id,team:`enemy`,templateId:this.templates[1]?.id??this.templates[0].id,classId:this.classDefinitions[0].id,levelId:c.startLevel,propRotationSteps:0,storyDraft:{trigger:`levelStart`,presentation:`dialog`,title:``,speaker:``,text:``,avatarUrl:``,x:0,z:0}}),this.root=e,this.root.className=`app-shell`,this.root.innerHTML=`
    ...
    `,this.canvas=this.root.querySelector(`.world-canvas`),this.panel=this.root.querySelector(`.editor-panel`),this.utility=this.root.querySelector(`.utility-layer`),this.loadStoredProject(),this.scene=new f(this.canvas,this.classDefinitions,this.environmentMaterials,this.propDefinitions),this.scene.onTileClick(e=>this.handleTileClick(e)),this.render(!0)}currentLevel(){return J(this.levels.find(e=>e.id===this.state.levelId)??this.levels[0])}setCurrentLevel(e){let t=J(e);this.levels=this.levels.map(e=>e.id===t.id?t:e)}selectedTemplate(){return this.templates.find(e=>e.id===this.state.templateId)??this.templates[0]}selectedClass(){return this.classDefinitions.find(e=>e.id===this.state.classId)??this.classDefinitions[0]}selectedMaterial(){return this.environmentMaterials.find(e=>e.id===this.state.terrain)??this.environmentMaterials[0]}selectedProp(){return this.propDefinitions.find(e=>e.id===this.state.obstacle)??this.propDefinitions[0]}loadStoredProject(){let n=N(e);if(!n)return;n.levels?.length?this.levels=n.levels.map(e=>J(e)):n.level&&(this.levels=[J(n.level)]),n.campaign&&(this.campaign=Q(n.campaign,this.levels));let i=n.terrainMaterials??n.environmentMaterials;i?.length&&(this.environmentMaterials=G(t,i));let a=n.props??n.propDefinitions;a?.length&&(this.propDefinitions=q(r,a));let o=n.classes??n.classDefinitions;o?.length&&(this.classDefinitions=H(d,o)),n.templates?.length&&(this.templates=n.templates.map(e=>structuredClone(e))),this.state.levelId=this.levels.find(e=>e.id===this.campaign.startLevel)?.id??this.levels[0]?.id??this.state.levelId,this.state.templateId=this.templates[1]?.id??this.templates[0]?.id??this.state.templateId,this.state.classId=this.classDefinitions[0]?.id??this.state.classId,this.state.terrain=this.environmentMaterials[0]?.id??this.state.terrain,this.state.obstacle=this.propDefinitions[0]?.id??this.state.obstacle}editorBundle(){return{campaign:this.campaign,levels:this.levels,level:this.currentLevel(),templates:this.templates,classes:this.classDefinitions,terrainMaterials:this.environmentMaterials,props:this.propDefinitions}}editorJson(){return JSON.stringify(this.editorBundle(),null,2)}emptyStoryDraft(){return{trigger:`levelStart`,presentation:`dialog`,title:``,speaker:``,text:``,avatarUrl:``,x:0,z:0}}storyDraftFromBeat(e){return{editingId:e.id,trigger:e.trigger,presentation:e.presentation,title:e.title,speaker:e.speaker,text:e.text,avatarUrl:e.avatarUrl??``,x:Math.max(0,Math.round(P(e.x,0))),z:Math.max(0,Math.round(P(e.z,0)))}}editorPreviewBundle(){return{...this.editorBundle(),campaign:{...this.campaign,startLevel:this.state.levelId,titleScreen:{...Y(this.campaign.titleScreen,this.state.levelId),backgroundLevelId:this.state.levelId}}}}openClientPreview(){this.syncStoryDraftFromPanel();let t={version:1,source:`editor`,timestamp:Date.now(),campaignId:this.campaign.id,startLevelId:this.state.levelId,content:this.editorPreviewBundle()};localStorage.setItem(e,this.editorJson()),localStorage.setItem(u,JSON.stringify(t)),localStorage.removeItem(i(this.campaign.id));let n=new URL(`client.html`,window.location.href);n.searchParams.set(`preview`,`editor`),n.searchParams.set(`level`,this.state.levelId),n.searchParams.set(`t`,String(t.timestamp)),window.location.href=n.href}levelOptions(e,t=!1){return`${t?`<option value="">Campaign End</option>`:``}${this.levels.map(t=>`<option value="${A(t.id)}" ${t.id===e?`selected`:``}>${A(t.name)}</option>`).join(``)}`}downloadJsonFile(e,t){let n=new Blob([t],{type:`application/json`}),r=document.createElement(`a`);r.href=URL.createObjectURL(n),r.download=e,document.body.append(r),r.click(),r.remove(),URL.revokeObjectURL(r.href)}openUtility(e){this.utility.className=`utility-layer open`,this.utility.innerHTML=e,this.utility.querySelectorAll(`[data-utility-action]`).forEach(e=>{e.addEventListener(`click`,()=>this.handleUtilityAction(e.dataset.utilityAction??``,e.dataset.levelId))}),this.utility.onclick=e=>{e.target===this.utility&&this.closeUtility()}}closeUtility(){this.utility.className=`utility-layer`,this.utility.innerHTML=``}openLevelFlowEditor(){let e=this.levels.some(e=>e.id===this.campaign.startLevel)?this.campaign.startLevel:this.levels[0].id;this.openUtility(`
      <div class="utility-modal flow-modal" role="dialog" aria-modal="true" aria-label="Level flow editor">
        ...
        <div class="compact-grid">
          <label class="field">
            ...
            <input data-flow-campaign="id" type="text" value="${A(this.campaign.id)}">
          </label>
          <label class="field">
            <span>Campaign Title</span>
            <input data-flow-campaign="title" type="text" value="${A(this.campaign.title)}">
          </label>
          <label class="field">
        ...
        <div class="flow-list">
          ${this.levels.map((e,t)=>{let n=this.campaign.levels.find(t=>t.id===e.id)?.next[0]??``,r=e.links[0]?.to??n;return`
                <div class="flow-row" data-flow-row data-level-id="${A(e.id)}">
                  <strong>${t+1}</strong>
                  <label>
                    <span>Name</span>
                    <input data-flow-field="name" type="text" value="${A(e.name)}">
                  </label>
                  <label>
                    <span>ID</span>
                    <input data-flow-field="id" type="text" value="${A(e.id)}">
                  </label>
                  <label>
                    <span>Next</span>
                    <select data-flow-field="next">${this.levelOptions(r,!0)}</select>
                  </label>
                  <button data-utility-action="open-level" data-level-id="${A(e.id)}">Open</button>
                </div>
              `}).join(``)}
        </div>
    ...
    `)}openTitleEditor(){let e=Y(this.campaign.titleScreen,this.campaign.startLevel);this.openUtility(`
      <div class="utility-modal title-editor-modal" role="dialog" aria-modal="true" aria-label="Title screen editor">
        ...
        <div class="compact-grid">
          <label class="field">
            <span>Kicker</span>
            <input data-title-field="kicker" type="text" value="${A(e.kicker)}">
          </label>
          <label class="field">
            <span>Headline</span>
            <input data-title-field="headline" type="text" value="${A(e.headline)}">
          </label>
          <label class="field title-wide">
            <span>Subtitle</span>
            <textarea class="story-textarea" data-title-field="subhead">${A(e.subhead)}</textarea>
          </label>
          <label class="field">
      ...
      <div class="utility-modal rules-editor-modal" role="dialog" aria-modal="true" aria-label="Gameplay rules editor">
        ...
        <div class="compact-grid">
          ...
          <label class="field title-wide">
            ...
            <textarea class="story-textarea rules-textarea" data-rules-field="conditions">${A(Te(e.conditions))}</textarea>
          </label>
        </div>
        <div class="title-preview-note">
    ...
    `)}handleUtilityAction(e,t){if(e===`close`)this.closeUtility();else if(e===`open-level`&&t)this.state.levelId=t,this.state.selected=void 0,this.render(!0),this.flash(`Opened ${this.currentLevel().name}.`);else if(e===`add-flow-level`)this.addBlankLevel(),this.openLevelFlowEditor(),this.flash(`Added a blank level to the flow.`);else if(e===`apply-flow`)this.applyLevelFlowEditor();else if(e===`apply-title`)this.applyTitleEditor();else if(e===`apply-rules`)this.applyGameplayRulesEditor();else if(e===`preview-title-level`){let e=this.utility.querySelector(`[data-title-field='backgroundLevelId']`)?.value;e&&this.levels.some(t=>t.id===e)&&(this.state.levelId=e,this.state.selected=void 0,this.render(!0),this.flash(`Opened the title backdrop level for visual editing.`))}}addBlankLevel(){let e=this.uniqueLevelId(`level-${this.levels.length+1}`),t=`New Level ${this.levels.length+1}`,n=J({id:e,name:t,width:10,depth:8,environment:structuredClone(a),tiles:l(10,8),obstacles:[],surroundings:[],units:[],objectives:[{type:`defeatTeam`,team:`enemy`}],links:[],story:[]}),r=this.levels[this.levels.length-1];r&&r.links.length===0&&(r.links=[{id:`${r.id}-next`,label:`Continue to ${t}`,to:e}]),this.levels.push(n);let i=this.campaign.levels[this.campaign.levels.length-1];i&&i.next.length===0&&(i.next=[e]),this.campaign.levels.push({id:e,file:`levels/${e}.json`,next:[]}),this.state.levelId=e,this.state.selected=void 0,this.render(!0)}applyLevelFlowEditor(){let e=[...this.utility.querySelectorAll(`[data-flow-row]`)];if(e.length===0)return;let t=new Map,n=new Set;for(let r of e){let e=r.dataset.levelId??``,i=r.querySelector(`[data-flow-field='name']`)?.value.trim()||`Level`,a=M(r.querySelector(`[data-flow-field='id']`)?.value.trim()||i),o=a,s=2;for(;n.has(o);)o=`${a}-${s}`,s+=1;n.add(o),t.set(e,o)}let r=e.map(e=>{let n=e.dataset.levelId??``,r=this.levels.find(e=>e.id===n)??this.currentLevel(),i=e.querySelector(`[data-flow-field='name']`)?.value.trim()||r.name,a=t.get(n)??r.id,o=e.querySelector(`[data-flow-field='next']`)?.value??``,s=o?t.get(o)??o:``;return J({...r,id:a,name:i,links:s?[{id:`${a}-next`,label:`Continue to ${s}`,to:s}]:[]})}),i=new Map(r.map(e=>[e.id,e.name])),a=r.map(e=>({...e,links:e.links.map(e=>({...e,label:`Continue to ${i.get(e.to)??e.to}`}))})),o=this.utility.querySelector(`[data-flow-campaign='id']`),s=this.utility.querySelector(`[data-flow-campaign='title']`),c=this.utility.querySelector(`[data-flow-campaign='startLevel']`),l=t.get(c?.value??``)??r[0].id,u=Y(this.campaign.titleScreen,l);u.backgroundLevelId=t.get(u.backgroundLevelId)??u.backgroundLevelId,a.some(e=>e.id===u.backgroundLevelId)||(u.backgroundLevelId=l),this.levels=a,this.campaign={...this.campaign,id:M(o?.value||this.campaign.id),title:s?.value.trim()||this.campaign.title,startLevel:l,titleScreen:u,levels:a.map(e=>({id:e.id,file:`levels/${e.id}.json`,next:e.links[0]?.to?[e.links[0].to]:[]}))},this.state.levelId=t.get(this.state.levelId)??l,this.state.selected=void 0,this.closeUtility(),this.render(!0),this.flash(`Updated campaign flow.`)}applyTitleEditor(){let e=e=>this.utility.querySelector(`[data-title-field='${e}']`),t=e(`backgroundLevelId`)?.value||this.campaign.startLevel;this.campaign={...this.campaign,titleScreen:{kicker:e(`kicker`)?.value.trim()||`Voxel tactics prototype`,headline:e(`headline`)?.value.trim()||`Craft Heroes`,subhead:e(`subhead`)?.value.trim()||`Rotate class faces, chain handmade levels, and test the build language for a Steam-ready tactics pitch.`,backgroundLevelId:t,cameraOrbit:e(`cameraOrbit`)?.checked??!0,orbitSpeed:Math.max(.01,Math.min(.4,P(e(`orbitSpeed`)?.value,.08))),mockBattle:e(`mockBattle`)?.checked??!0}},this.closeUtility(),this.updatePanel(),this.flash(`Updated title screen settings.`)}applyGameplayRulesEditor(){let e=e=>this.utility.querySelector(`[data-rules-field='${e}']`),t=Z(this.campaign.gameplay),n=e(`tieBreaker`)?.value,r=n===`enemy`||n===`higherHp`||n===`player`?n:t.initiative.tieBreaker,i=e(`conditions`)?.value??Te(t.conditions);this.campaign={...this.campaign,gameplay:Z({initiative:{base:P(e(`base`)?.value,t.initiative.base),headWeight:P(e(`headWeight`)?.value,t.initiative.headWeight),bodyWeight:P(e(`bodyWeight`)?.value,t.initiative.bodyWeight),legsWeight:P(e(`legsWeight`)?.value,t.initiative.legsWeight),heightWeight:P(e(`heightWeight`)?.value,t.initiative.heightWeight),conditionWeight:P(e(`conditionWeight`)?.value,t.initiative.conditionWeight),random:P(e(`random`)?.value,t.initiative.random),tieBreaker:r},conditions:Ee(i,t.conditions)})},this.closeUtility(),this.updatePanel(),this.flash(`Updated gameplay rules.`)}propRotationAngle(){return this.state.propRotationSteps*(Math.PI/2)}propRotationLabel(){return`${this.state.propRotationSteps*90} deg`}uniqueTemplateId(e){let t=se(e),n=t,r=2;for(;this.templates.some(e=>e.id===n);)n=`${t}-${r}`,r+=1;return n}uniqueClassId(e){let t=ce(e),n=t,r=2;for(;this.classDefinitions.some(e=>e.id===n);)n=`${t}-${r}`,r+=1;return n}uniqueMaterialId(e){let t=le(e),n=t,r=2;for(;this.environmentMaterials.some(e=>e.id===n);)n=`${t}-${r}`,r+=1;return n}uniquePropId(e){let t=ue(e),n=t,r=2;for(;this.propDefinitions.some(e=>e.id===n);)n=`${t}-${r}`,r+=1;return n}uniqueLevelId(e){let t=M(e),n=t,r=2;for(;this.levels.some(e=>e.id===n);)n=`${t}-${r}`,r+=1;return n}classOptions(e){return this.classDefinitions.map(t=>`<option value="${A(t.id)}" ${t.id===e?`selected`:``}>${A(t.name)}</option>`).join(``)}materialOptions(e){return this.environmentMaterials.map(t=>`<option value="${A(t.id)}" ${t.id===e?`selected`:``}>${A(t.name)}</option>`).join(``)}propOptions(e){return this.propDefinitions.map(t=>`<option value="${A(t.id)}" ${t.id===e?`selected`:``}>${A(t.name)}</option>`).join(``)}readBuildDraft(e=this.state.templateId){let t=this.selectedTemplate(),n=this.panel.querySelector(`[data-build='name']`),r=this.panel.querySelector(`[data-build='hp']`),i=structuredClone(t.faces);for(let e of S)for(let t=0;t<oe.length;t+=1){let n=this.panel.querySelector(`[data-face-section='${e}'][data-face-index='${t}']`);i[e][t]=n?.value??i[e][t]}return{id:e,name:n?.value.trim()||t.name,hp:Math.max(1,Math.min(99,Number(r?.value||t.hp))),faces:i}}readClassDraft(e=this.state.classId){let t=this.selectedClass(),n=this.panel.querySelector(`[data-class='name']`),r=this.panel.querySelector(`[data-class='color']`),i=structuredClone(t.sections);for(let e of S){for(let t of T){let n=P(this.panel.querySelector(`[data-class-section='${e}'][data-stat='${t.key}']`)?.value,i[e].stats[t.key]);i[e].stats[t.key]=Math.max(0,Math.min(12,n))}let t=this.panel.querySelector(`[data-class-section='${e}'][data-ability]`),n=this.panel.querySelector(`[data-class-section='${e}'][data-condition]`);i[e].abilities=Ce(t?.value??Se(i[e].abilities),i[e].abilities),i[e].conditions=we(n?.value??$(i[e].conditions))}return V({id:e,name:n?.value.trim()||t.name,color:r?.value||t.color,sections:i})}replaceClassDefinition(e){this.classDefinitions=this.classDefinitions.map(t=>t.id===e.id?e:t),this.scene.setClassDefinitions(this.classDefinitions)}readMaterialDraft(e=this.state.terrain){let t=this.selectedMaterial(),n=this.panel.querySelector(`[data-material='name']`),r=this.panel.querySelector(`[data-material='topColor']`),i=this.panel.querySelector(`[data-material='sideColor']`),a=this.panel.querySelector(`[data-material='sideCapColor']`),o=this.panel.querySelector(`[data-material='sideFullColor']`),s=this.panel.querySelector(`[data-material='sideHalfColor']`),c=this.panel.querySelector(`[data-material='surfaceEffect']`),l=this.panel.querySelector(`[data-material='grassDensity']`),u=this.panel.querySelector(`[data-material='grassHeightMin']`),d=this.panel.querySelector(`[data-material='grassHeightMax']`),f=[...this.panel.querySelectorAll(`[data-material-grass-color]`)],p=this.panel.querySelector(`[data-material='movementCost']`),m=this.panel.querySelector(`[data-material='blocksLineOfSight']`),h=this.panel.querySelector(`[data-material='topRule']`),g=this.panel.querySelector(`[data-material='sideRule']`);return W({...t,id:e,name:n?.value.trim()||t.name,topColor:r?.value||t.topColor,sideColor:i?.value||t.sideColor,sideCapColor:a?.value||t.sideCapColor,sideFullColor:o?.value||t.sideFullColor,sideHalfColor:s?.value||t.sideHalfColor,surfaceEffect:R(c?.value??t.surfaceEffect),grassDensity:P(l?.value,t.grassDensity),grassHeightMin:P(u?.value,t.grassHeightMin),grassHeightMax:P(d?.value,t.grassHeightMax),grassColors:B(f.map(e=>e.value),t.grassColors),topRule:h?.value.trim()||t.topRule,sideRule:g?.value.trim()||t.sideRule,movementCost:P(p?.value,t.movementCost),blocksLineOfSight:!!m?.checked})}replaceMaterialDefinition(e){this.environmentMaterials=this.environmentMaterials.map(t=>t.id===e.id?e:t),this.scene.setEnvironmentMaterials(this.environmentMaterials)}readPropDraft(e=this.state.obstacle){let t=this.selectedProp(),n=this.panel.querySelector(`[data-prop='name']`),r=this.panel.querySelector(`[data-prop='role']`),i=this.panel.querySelector(`[data-prop='assetKind']`),a=this.panel.querySelector(`[data-prop='color']`),o=this.panel.querySelector(`[data-prop='width']`),s=this.panel.querySelector(`[data-prop='height']`),c=this.panel.querySelector(`[data-prop='depth']`),l=this.panel.querySelector(`[data-prop='blocksMovement']`),u=this.panel.querySelector(`[data-prop='blocksLineOfSight']`),d=this.panel.querySelector(`[data-prop='coverBonus']`),f=this.panel.querySelector(`[data-prop='fitModelToTile']`),p=this.panel.querySelector(`[data-prop='windEffect']`),m=this.panel.querySelector(`[data-prop='emitsLight']`),h=this.panel.querySelector(`[data-prop='lightColor']`),g=this.panel.querySelector(`[data-prop='lightIntensity']`),_=this.panel.querySelector(`[data-prop='lightRange']`),v=this.panel.querySelector(`[data-prop='lightOffsetY']`),y=this.panel.querySelector(`[data-prop='notes']`);return K({...t,id:e,name:n?.value.trim()||t.name,role:r?.value??t.role,assetKind:i?.value??t.assetKind,color:a?.value||t.color,width:P(o?.value,t.width),height:P(s?.value,t.height),depth:P(c?.value,t.depth),blocksMovement:!!l?.checked,blocksLineOfSight:!!u?.checked,coverBonus:P(d?.value,t.coverBonus),fitModelToTile:f?.checked??t.fitModelToTile,windEffect:p?.checked??t.windEffect,emitsLight:m?.checked??t.emitsLight,lightColor:h?.value||t.lightColor,lightIntensity:P(g?.value,t.lightIntensity),lightRange:P(_?.value,t.lightRange),lightOffsetY:P(v?.value,t.lightOffsetY),notes:we(y?.value??$(t.notes))})}replacePropDefinition(e){this.propDefinitions=this.propDefinitions.map(t=>t.id===e.id?e:t),this.scene.setPropDefinitions(this.propDefinitions)}readEnvironmentDraft(e){let t=this.panel.querySelector(`[data-environment='skyColor']`),n=this.panel.querySelector(`[data-environment='fogColor']`),r=this.panel.querySelector(`[data-environment='groundColor']`),i=this.panel.querySelector(`[data-environment='ambientIntensity']`),a=this.panel.querySelector(`[data-environment='sunIntensity']`),o=this.panel.querySelector(`[data-environment='windStrength']`),s=this.panel.querySelector(`[data-environment='windSpeed']`),c=this.panel.querySelector(`[data-background='scale']`),l=this.panel.querySelector(`[data-background='rotation']`),u=this.panel.querySelector(`[data-background='offsetY']`),d=this.panel.querySelector(`[data-background='fitToMap']`);return U({...e.environment,skyColor:t?.value||e.environment.skyColor,fogColor:n?.value||e.environment.fogColor,groundColor:r?.value||e.environment.groundColor,ambientIntensity:P(i?.value,e.environment.ambientIntensity),sunIntensity:P(a?.value,e.environment.sunIntensity),windStrength:P(o?.value,e.environment.windStrength),windSpeed:P(s?.value,e.environment.windSpeed),backgroundModel:{...e.environment.backgroundModel,fitToMap:d?.checked??e.environment.backgroundModel.fitToMap,scale:P(c?.value,e.environment.backgroundModel.scale),rotation:P(l?.value,e.environment.backgroundModel.rotation),offsetY:P(u?.value,e.environment.backgroundModel.offsetY)}})}readStoryDraft(){this.syncStoryDraftFromPanel();let e=this.state.storyDraft,t={id:e.editingId||`story-${Date.now()}`,trigger:e.trigger,presentation:e.presentation,title:e.title.trim(),speaker:e.speaker.trim(),text:e.text.trim()||`New story beat`,avatarUrl:e.avatarUrl.trim(),...e.trigger===`tileEnter`?{x:Math.round(P(e.x,this.state.selected?.x??0)),z:Math.round(P(e.z,this.state.selected?.z??0))}:{}};return t.avatarUrl?t:{...t,avatarUrl:``}}syncStoryDraftFromPanel(){let e=this.panel.querySelector(`[data-story='trigger']`),t=this.panel.querySelector(`[data-story='presentation']`),n=this.panel.querySelector(`[data-story='title']`),r=this.panel.querySelector(`[data-story='speaker']`),i=this.panel.querySelector(`[data-story='avatarUrl']`),a=this.panel.querySelector(`[data-story='text']`),o=this.panel.querySelector(`[data-story='x']`),s=this.panel.querySelector(`[data-story='z']`),c=e?.value===`tileEnter`||e?.value===`levelComplete`?e.value:`levelStart`,l=t?.value===`screen`?`screen`:`dialog`;this.state.storyDraft={editingId:this.state.storyDraft.editingId,trigger:c,presentation:l,title:n?.value??this.state.storyDraft.title,speaker:r?.value??this.state.storyDraft.speaker,text:a?.value??this.state.storyDraft.text,avatarUrl:i?.value??this.state.storyDraft.avatarUrl,x:Math.max(0,Math.round(P(o?.value,this.state.storyDraft.x))),z:Math.max(0,Math.round(P(s?.value,this.state.storyDraft.z)))}}setStoryDraftTile(e){this.syncStoryDraftFromPanel(),this.state.storyDraft={...this.state.storyDraft,trigger:`tileEnter`,x:e.x,z:e.z},this.state.selected=e,this.scene.setSelected(e),this.updatePanel(),this.flash(`Story tile set to ${e.x}, ${e.z}.`)}applyLevelSize(){let e=this.panel.querySelector(`[data-size='width']`),t=this.panel.querySelector(`[data-size='depth']`),n=Number(e?.value||this.currentLevel().width),r=Number(t?.value||this.currentLevel().depth),i=te(this.currentLevel(),n,r,this.state.terrain);this.setCurrentLevel(i),this.state.selected&&(this.state.selected.x>=i.width||this.state.selected.z>=i.depth)&&(this.state.selected=void 0),this.scene.setLevel(i),this.scene.setSelected(this.state.selected),this.updatePanel()}applyPropRotation(e){this.state.propRotationSteps=(e%4+4)%4;let t=this.currentLevel();if(!this.state.selected){this.updatePanel(),this.flash(`Prop rotation set to ${this.propRotationLabel()}.`);return}let n=!1,r={...t,obstacles:t.obstacles.map(e=>e.x!==this.state.selected?.x||e.z!==this.state.selected.z?e:(n=!0,{...e,rotation:this.propRotationAngle()}))};n?(this.setCurrentLevel(r),this.scene.setLevel(r),this.scene.setSelected(this.state.selected),this.flash(`Rotated selected prop to ${this.propRotationLabel()}.`)):this.flash(`Prop rotation set to ${this.propRotationLabel()}.`),this.updatePanel()}handleTileClick(e){if(this.state.selected=e,this.state.mode===`play`){this.scene.setSelected(e),this.updatePanel();return}let t=this.currentLevel(),n=t;if(this.state.tool===`raise`)n=x(t,e,1);else if(this.state.tool===`lower`)n=x(t,e,-1);else if(this.state.tool===`paint`)n=ee(t,e,this.state.terrain);else if(this.state.tool===`obstacle`)n=ne(t,e,this.state.obstacle,this.propRotationAngle());else if(this.state.tool===`unit`){let r=this.selectedTemplate();n=re(t,e,this.state.team,r)}else if(this.state.tool===`story`){this.setStoryDraftTile(e);return}else this.state.tool===`erase`&&(n=ie(t,e));this.setCurrentLevel(n),this.scene.setLevel(n),this.scene.setSelected(e),this.updatePanel()}render(e=!1){this.scene.setMode(this.state.mode),this.scene.setLevel(this.currentLevel(),{frame:e}),this.scene.setSelected(this.state.selected),this.updatePanel()}updatePanel(){let e=this.currentLevel(),t=ae(e),n=this.selectedTemplate(),r=this.selectedClass(),i=this.selectedMaterial(),a=this.selectedProp(),o=this.state.selected?e.obstacles.find(e=>e.x===this.state.selected?.x&&e.z===this.state.selected?.z):void 0,s=this.state.storyDraft,c=this.editorJson(),l=[{label:`Classes`,count:this.classDefinitions.length,details:this.classDefinitions.map(e=>e.name).join(`, `)},{label:`Builds`,count:this.templates.length,details:this.templates.map(e=>e.name).join(`, `)},{label:`Props`,count:this.propDefinitions.length,details:this.propDefinitions.map(e=>e.name).join(`, `)},{label:`Materials`,count:this.environmentMaterials.length,details:this.environmentMaterials.map(e=>e.name).join(`, `)}];this.panel.innerHTML=`
      ...
      <label class="field">
        ...
        <select data-field="levelId">
          ${this.levels.map(e=>`<option value="${A(e.id)}" ${e.id===this.state.levelId?`selected`:``}>${A(e.name)}</option>`).join(``)}
        </select>
      </label>
      ...
      <div class="compact-grid">
        ...
        <label class="field">
          ...
          <select data-field="templateId">
            ${this.templates.map(e=>`<option value="${A(e.id)}" ${e.id===this.state.templateId?`selected`:``}>${A(e.name)}</option>`).join(``)}
          </select>
        </label>
      </div>
      <section class="control-section">
        <div class="section-title">
          ...
          <span>${o?`Selected ${A(o.type)} @ ${o.x}, ${o.z}`:`Set rotation before placing GLB props or blockers.`}</span>
        </div>
        <div class="button-row two">
      ...
      <section class="control-section">
        ...
        <div class="compact-grid">
          <label class="field">
            <span>Sky</span>
            <input data-environment="skyColor" type="color" value="${A(e.environment.skyColor)}">
          </label>
          <label class="field">
            <span>Fog</span>
            <input data-environment="fogColor" type="color" value="${A(e.environment.fogColor)}">
          </label>
          <label class="field">
            <span>Ground</span>
            <input data-environment="groundColor" type="color" value="${A(e.environment.groundColor)}">
          </label>
          <label class="field">
        ...
        <div class="asset-preview-head">
          <div>
            ...
            <span>${A(e.environment.backgroundModel.modelFileName||`No map surround loaded`)}</span>
          </div>
      ...
      <section class="control-section">
        ...
        <div class="compact-grid">
          <label class="field">
            ...
            <select data-story="trigger">
              <option value="levelStart" ${s.trigger===`levelStart`?`selected`:``}>Level Start</option>
              <option value="tileEnter" ${s.trigger===`tileEnter`?`selected`:``}>Tile Enter</option>
              <option value="levelComplete" ${s.trigger===`levelComplete`?`selected`:``}>Level Complete</option>
            </select>
          </label>
          <label class="field">
            <span>Presentation</span>
            <select data-story="presentation">
              <option value="dialog" ${s.presentation===`dialog`?`selected`:``}>Dialog</option>
              <option value="screen" ${s.presentation===`screen`?`selected`:``}>Story Screen</option>
            </select>
          </label>
          <label class="field">
            <span>Tile X (left to right)</span>
            <input data-story="x" type="number" min="0" max="${Math.max(0,e.width-1)}" step="1" value="${s.x}">
          </label>
          <label class="field">
            <span>Tile Z (back to front)</span>
            <input data-story="z" type="number" min="0" max="${Math.max(0,e.depth-1)}" step="1" value="${s.z}">
          </label>
          <label class="field">
            <span>Title</span>
            <input data-story="title" type="text" placeholder="Optional title" value="${A(s.title)}">
          </label>
          <label class="field">
            <span>Speaker</span>
            <input data-story="speaker" type="text" placeholder="Optional speaker" value="${A(s.speaker)}">
          </label>
          <label class="field">
            <span>Avatar URL</span>
            <input data-story="avatarUrl" type="text" placeholder="Optional portrait image URL" value="${A(s.avatarUrl)}">
          </label>
        </div>
        <div class="story-avatar-editor">
          <div class="story-avatar-preview">
            ${s.avatarUrl?`<img src="${A(s.avatarUrl)}" alt="">`:`<span>${A((s.speaker||`CH`).slice(0,2).toUpperCase())}</span>`}
          </div>
          <div>
            <strong>${s.editingId?`Editing Story Beat`:`New Story Beat`}</strong>
            <span>Upload an optional speaker portrait, or paste an image URL.</span>
          </div>
          <input data-story-avatar type="file" accept="image/*">
          <button data-action="clear-story-avatar" ${s.avatarUrl?``:`disabled`}>Clear Avatar</button>
        </div>
        <div class="story-picker">
          <strong>Tile target</strong>
          <span>${s.trigger===`tileEnter`?`Tile ${s.x}, ${s.z} selected. Origin 0,0 is the back-left tile from the default camera.`:`Only used when Trigger is Tile Enter.`}</span>
          <div class="button-row two">
        ...
        <label class="field">
          ...
          <textarea class="story-textarea" data-story="text" placeholder="What happens here?">${A(s.text)}</textarea>
        </label>
        <div class="button-row two">
          <button data-action="add-story">${s.editingId?`Update Story Beat`:`Add Story Beat`}</button>
          <button data-action="new-story-draft" ${s.editingId?``:`disabled`}>New Story Beat</button>
        </div>
        <div class="story-list">
          ${e.story.map(e=>`
                <div class="story-item ${s.editingId===e.id?`active`:``}">
                  <div class="story-item-avatar">
                    ${e.avatarUrl?`<img src="${A(e.avatarUrl)}" alt="">`:`<span>${A((e.speaker||e.title||`ST`).slice(0,2).toUpperCase())}</span>`}
                  </div>
                  <div>
                    <strong>${A(e.title||e.speaker||e.presentation)}</strong>
                    <span>${A(e.trigger)}${e.trigger===`tileEnter`?` @ ${e.x}, ${e.z}`:``} / ${A(e.text)}</span>
                  </div>
                  <button data-action="edit-story" data-story-id="${A(e.id)}" title="Edit story beat" aria-label="Edit story beat">Edit</button>
                  <button data-action="remove-story" data-story-id="${A(e.id)}" title="Remove story beat" aria-label="Remove story beat">&times;</button>
                </div>
        ...
        <div class="library-grid">
          ${l.map(e=>`
                <div class="library-card">
                  ...
                  <span>${A(e.label)}</span>
                  <small>${A(e.details||`None yet`)}</small>
                </div>
              `).join(``)}
        </div>
      ...
      <section class="control-section">
        ...
        <div class="compact-grid">
          <label class="field">
            <span>Name</span>
            <input data-material="name" type="text" value="${A(i.name)}">
          </label>
          <label class="field">
            <span>Move Cost</span>
          ...
          <label class="field">
            <span>Top Color</span>
            <input data-material="topColor" type="color" value="${A(i.topColor)}">
          </label>
          <label class="field">
            <span>Legacy Side</span>
            <input data-material="sideColor" type="color" value="${A(i.sideColor)}">
          </label>
        </div>
        <div class="compact-grid">
          ${i.grassColors.map((e,t)=>`
                <label class="field">
                  ...
                  <input data-material-grass-color type="color" value="${A(e)}">
                </label>
              `).join(``)}
        </div>
        <div class="asset-pair">
          ...
          <div class="asset-preview-head">
            ...
            ${j(i.sideFullImageUrl)}
          </div>
          <div class="asset-preview-head">
            <strong>Half Side</strong>
            ${j(i.sideHalfImageUrl)}
          </div>
        </div>
        <div class="compact-grid">
          <label class="field">
        ...
        <div class="compact-grid">
          <label class="field">
            ...
            <input data-material="sideCapColor" type="color" value="${A(i.sideCapColor)}">
          </label>
          <label class="field">
            <span>Full Side Color</span>
            <input data-material="sideFullColor" type="color" value="${A(i.sideFullColor)}">
          </label>
          <label class="field">
            <span>Half Side Color</span>
            <input data-material="sideHalfColor" type="color" value="${A(i.sideHalfColor)}">
          </label>
        </div>
        <label class="field">
          <span>Top Rule</span>
          <input data-material="topRule" type="text" value="${A(i.topRule)}">
        </label>
        <label class="field">
          <span>Side Rule</span>
          <input data-material="sideRule" type="text" value="${A(i.sideRule)}">
        </label>
        <label class="check-row">
      ...
      <section class="control-section">
        ...
        <div class="compact-grid">
          <label class="field">
            <span>Name</span>
            <input data-prop="name" type="text" value="${A(a.name)}">
          </label>
          <label class="field">
            <span>Role</span>
          ...
          <label class="field">
            <span>Color</span>
            <input data-prop="color" type="color" value="${A(a.color)}">
          </label>
          <label class="field">
        ...
        <div class="compact-grid">
          <label class="field">
            ...
            <input data-prop="lightColor" type="color" value="${A(a.lightColor)}">
          </label>
          <label class="field">
            <span>Intensity</span>
        ...
        <label class="field">
          <span>Notes</span>
          <input data-prop="notes" type="text" value="${A($(a.notes))}">
        </label>
        <div class="button-row two">
      ...
      <section class="control-section">
        ...
        <div class="compact-grid">
          <label class="field">
            ...
            <input data-class="name" type="text" value="${A(r.name)}">
          </label>
          <label class="field">
            <span>Color</span>
            <input data-class="color" type="color" value="${A(r.color)}">
          </label>
        </div>
        <div class="class-section-list">
          ${S.map(e=>{let t=r.sections[e];return`
                <div class="class-section-card">
                  ...
                  <label class="field">
                    ...
                    <input data-class-section="${e}" data-condition type="text" value="${A($(t.conditions))}">
                  </label>
                  <label class="field">
                    <span>Abilities</span>
                    <textarea class="ability-textarea" data-class-section="${e}" data-ability>${A(Se(t.abilities))}</textarea>
                  </label>
                </div>
              `}).join(``)}
        </div>
      ...
      <section class="control-section">
        ...
        <div class="compact-grid">
          <label class="field">
            ...
            <input data-build="name" type="text" value="${A(n.name)}">
          </label>
          <label class="field">
            <span>HP</span>
